...
public class Test8EvaluateActivity extends AppCompatActivity {

    private TestMessagePackage msgPackage;
    private RatingBar mBar;
    private Intent intent;

    public void submitAndNext8(View view) {

        //Log.i("TAG", "rating: " + mBar.getRating());
        msgPackage.preference8 = mBar.getRating();
        if (msgPackage.lastTestNum == 8)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test8_evaluate);
        ...
        mBar = (RatingBar) findViewById(R.id.ratingBar8);
    }
}