...
public class Test3EvaluateActivity extends AppCompatActivity {

    private TestMessagePackage msgPackage;
    private RatingBar mBar;
    private Intent intent;

    public void submitAndNext3(View view) {

        //Log.i("TAG", "rating: " + mBar.getRating());
        msgPackage.preference3 = mBar.getRating();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test3_evaluate);
        ...
        mBar = (RatingBar) findViewById(R.id.ratingBar3);
    }
}